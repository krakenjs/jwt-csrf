...
// utitlies
var filterUrls = require('../helpers').filterUrls;
var getExcludedUrls = require('../helpers').getExcludedUrls;
/*
    CSRF Error
    ----------
...
module.exports = {
    ...
    middleware: function (options) {
        ...
        var excludeUrls = getExcludedUrls(options);
        ...
        return function (req, res, next) {
            ...
            if (excludeUrls.length) {
                ...
                excludeTheseUrls = excludeUrls.filter((url, i, arr) => filterUrls(url, arr, urlToTest));
